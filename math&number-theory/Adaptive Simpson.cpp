double f(double a) {}
double adaptiveSimpsonsAux(double a, double b, double epsilon, double S,
...
//
double adaptiveSimpsons(double a, double b,             //
                        interval[a, b] double epsilon,  // error
                        tolerance int maxRecursionDepth) {
  // recursion cap
  double c = (a + b) / 2, h = b - a;
